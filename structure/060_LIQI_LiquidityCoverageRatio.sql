-- ============================================================
-- REP_RAW_001 Schema - FINMA LCR Raw Data Ingestion
-- Generated on: 2026-01-07
-- ============================================================
--
-- OVERVIEW:
-- This schema stores raw data for FINMA Liquidity Coverage Ratio (LCR) reporting
-- including High-Quality Liquid Assets (HQLA) holdings and deposit balances.
-- Data is loaded from CSV files generated by lcr_data_generator.py.
--
-- BUSINESS PURPOSE:
-- - Store daily HQLA securities positions for liquidity buffer calculation
-- - Track deposit balances for net cash outflow calculation (30-day stress)
-- - Support FINMA Circular 2015/2 and LiqV Art. 14-20 compliance
-- - Enable real-time LCR monitoring and SNB regulatory submission
-- - Maintain audit trail for Basel III liquidity risk management
--
-- OBJECTS CREATED:
-- ┌─ STAGES (2):
-- │  ├─ LIQI_RAW_STAGE_HQLA_HOLDINGS      - HQLA holdings CSV files
-- │  └─ LIQI_RAW_STAGE_DEPOSIT_BALANCES   - Deposit balances CSV files
-- │
-- ├─ TABLES (4):
-- │  ├─ LIQI_RAW_TB_HQLA_ELIGIBILITY      - Asset type classification & haircuts
-- │  ├─ LIQI_RAW_TB_DEPOSIT_TYPES         - Deposit type run-off rates
-- │  ├─ LIQI_RAW_TB_HQLA_HOLDINGS         - Daily HQLA securities holdings
-- │  └─ LIQI_RAW_TB_DEPOSIT_BALANCES      - Daily deposit account balances
-- │
-- ├─ STREAMS (2):
...
--
-- RELATED SCHEMAS:
-- - REP_AGG_001: Aggregation layer for LCR HQLA and outflow calculations
-- - REF_RAW_001: FX rates for multi-currency conversion to CHF
-- - CRM_RAW_001: Customer data for deposit relationship analysis
-- ============================================================
...
-- ============================================================================
-- Table: HQLA Asset Type Eligibility Rules
-- ============================================================================
-- Master reference table defining which assets qualify as HQLA under FINMA
-- Circular 2015/2 and Basel III, with regulatory haircut factors for LCR
-- numerator calculation. Used by Treasury for portfolio management and
-- compliance for regulatory reporting.
-- ============================================================================

CREATE OR REPLACE TABLE LIQI_RAW_TB_HQLA_ELIGIBILITY (
...
-- ============================================================================
-- Table: Deposit Type Run-off Rates
-- ============================================================================
-- Master reference table defining deposit classifications and stressed run-off
-- rates for 30-day net cash outflow calculation per FINMA Circular 2015/2.
-- Supports relationship-based discounts and operational deposit designations.
-- Used by Treasury for funding planning and ALM for liquidity stress testing.
-- ============================================================================

CREATE OR REPLACE TABLE LIQI_RAW_TB_DEPOSIT_TYPES (
...
-- ============================================================================
-- RAW DATA TABLES (Daily Snapshots)
-- ============================================================================

-- ============================================================================
-- Table: HQLA Holdings (Daily Positions)
-- ============================================================================
-- Daily snapshot of High-Quality Liquid Assets held by Treasury for liquidity
-- buffer management. Source data for LCR numerator calculation with regulatory
-- haircuts. Loaded from treasury management systems via CSV extracts.
-- Updated daily for real-time LCR monitoring and monthly SNB reporting.
-- ============================================================================

CREATE OR REPLACE TABLE LIQI_RAW_TB_HQLA_HOLDINGS (
...
-- ============================================================================
-- Table: Deposit Balances (Daily Positions)
-- ============================================================================
-- Daily snapshot of customer deposit balances enriched with regulatory
-- attributes for LCR outflow calculation. Links to actual customer base
-- (CRM_RAW_001) for cross-domain analytics. Source data for LCR denominator
-- with relationship-based run-off adjustments per FINMA Circular 2015/2.
-- ============================================================================

CREATE OR REPLACE TABLE LIQI_RAW_TB_DEPOSIT_BALANCES (
...
CREATE STAGE IF NOT EXISTS LIQI_RAW_STAGE_HQLA_HOLDINGS
    DIRECTORY = (ENABLE = TRUE AUTO_REFRESH = TRUE)
    COMMENT = 'Stage for HQLA holdings CSV files';

CREATE STAGE IF NOT EXISTS LIQI_RAW_STAGE_DEPOSIT_BALANCES
    DIRECTORY = (ENABLE = TRUE AUTO_REFRESH = TRUE)
...
CREATE OR REPLACE STREAM LIQI_RAW_STREAM_HQLA_FILES
    ON STAGE LIQI_RAW_STAGE_HQLA_HOLDINGS;

CREATE OR REPLACE STREAM LIQI_RAW_STREAM_DEPOSIT_FILES
    ON STAGE LIQI_RAW_STAGE_DEPOSIT_BALANCES;

-- ============================================================================
-- SERVERLESS TASKS FOR AUTOMATED DATA LOADING
-- ============================================================================

-- Task: Load HQLA Holdings
CREATE OR REPLACE TASK LIQI_RAW_TASK_LOAD_HQLA_HOLDINGS
    USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE = 'XSMALL'
    SCHEDULE = '60 MINUTE'
    WHEN SYSTEM$STREAM_HAS_DATA('LIQI_RAW_STREAM_HQLA_FILES')
AS
    ...
    FROM @LIQI_RAW_STAGE_HQLA_HOLDINGS
    FILE_FORMAT = (
        TYPE = 'CSV'
...
-- Task: Load Deposit Balances
CREATE OR REPLACE TASK LIQI_RAW_TASK_LOAD_DEPOSIT_BALANCES
    USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE = 'XSMALL'
    SCHEDULE = '60 MINUTE'
    WHEN SYSTEM$STREAM_HAS_DATA('LIQI_RAW_STREAM_DEPOSIT_FILES')
AS
    ...
    FROM @LIQI_RAW_STAGE_DEPOSIT_BALANCES
    FILE_FORMAT = (
        TYPE = 'CSV'
        FIELD_OPTIONALLY_ENCLOSED_BY = '"'
        SKIP_HEADER = 1
...
-- Query: Show all HQLA asset types with haircuts
-- SELECT 
--     ASSET_TYPE,
--     ASSET_NAME,
--     REGULATORY_LEVEL,
--     HAIRCUT_PCT || '%' as haircut_pct,
--     HAIRCUT_FACTOR,
--     SNB_COORDINATE,
--     ELIGIBILITY_CRITERIA
-- FROM LIQI_RAW_TB_HQLA_ELIGIBILITY
-- WHERE IS_ACTIVE = TRUE
-- ORDER BY REGULATORY_LEVEL, ASSET_TYPE;

-- Query: Show all deposit types with run-off rates
-- SELECT 
--     DEPOSIT_TYPE,
--     DEPOSIT_NAME,
--     ROUND(BASE_RUN_OFF_RATE * 100, 2) || '%' as run_off_rate,
--     COUNTERPARTY_TYPE,
--     SNB_COORDINATE,
--     CASE WHEN ALLOWS_RELATIONSHIP_DISCOUNT THEN 'YES' ELSE 'NO' END as relationship_discount
-- FROM LIQI_RAW_TB_DEPOSIT_TYPES
-- WHERE IS_ACTIVE = TRUE
-- ORDER BY COUNTERPARTY_TYPE, BASE_RUN_OFF_RATE;
