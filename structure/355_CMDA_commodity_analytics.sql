...
-- It transforms raw commodity trades from CMD_RAW_001.CMDI_RAW_TB_TRADES into 
...
--
-- DATA FLOW:
-- CMD_RAW_001.CMDI_RAW_TB_TRADES (raw trades)
--     ↓
...
WITH total_portfolio AS (
    ...
    FROM AAA_DEV_SYNTHETIC_BANK.CMD_RAW_001.CMDI_RAW_TB_TRADES
)
SELECT 
    t.COMMODITY_TYPE,
