...
-- ============================================================================
-- Alias View for Semantic Views Compatibility
-- ============================================================================
-- Create EMPA_AGG_VW_ADVISORS as an alias to EMPA_AGG_DT_ADVISOR_PERFORMANCE
-- to match the naming expected by semantic views (710_CRMA_SV_CUSTOMER_360, etc.)

CREATE OR REPLACE VIEW EMPA_AGG_VW_ADVISORS
