...
-- It transforms raw bond and swap trades from FII_RAW_001.FIII_RAW_TB_TRADES into 
...
--
-- DATA FLOW:
-- FII_RAW_001.FIII_RAW_TB_TRADES (raw trades)
--     ↓
...
WITH total_portfolio AS (
    ...
    FROM AAA_DEV_SYNTHETIC_BANK.FII_RAW_001.FIII_RAW_TB_TRADES
