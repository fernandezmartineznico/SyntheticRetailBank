...
LEFT JOIN CRM_AGG_001.ACCA_AGG_DT_ACCOUNTS a ON c.CUSTOMER_ID = a.CUSTOMER_ID
LEFT JOIN PAY_AGG_001.PAYA_AGG_DT_TRANSACTION_ANOMALIES t ON c.CUSTOMER_ID = t.CUSTOMER_ID
...
INNER JOIN CRM_RAW_001.CRMI_RAW_TB_CUSTOMER_EVENT e
...
LEFT JOIN LATERAL (
    ...
    FROM CRM_RAW_001.ACCI_RAW_TB_ACCOUNTS acc
    INNER JOIN PAY_RAW_001.PAYI_RAW_TB_TRANSACTIONS t ON acc.ACCOUNT_ID = t.ACCOUNT_ID
